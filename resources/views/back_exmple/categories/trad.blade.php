...
@section('breadcrumbs')
    <li class="breadcrumb-item "> <a href="{{ route('back789658.category.index') }}" >Toutes les catégories</a></li>
@endsection
@section('content')
<form class="form-admin" id="form-admin" action="{{route('back789658.category.traduction' , $category)}}" method="post" enctype="multipart/form-data">
      @csrf
      @method('post')
